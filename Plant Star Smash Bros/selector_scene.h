...
public:
	...
	void on_enter()
	{
		...
		pos_1P_selector_btn_left.x = pos_img_1P_gravestone.x - img_1P_selector_btn_down_left.getwidth();
		pos_1P_selector_btn_left.y = pos_img_1P_gravestone.y + (img_gravestone_right.getheight() - img_1P_selector_btn_idle_left.getheight()) / 2;
		pos_1P_selector_btn_right.x = pos_img_1P_gravestone.x + img_gravestone_right.getwidth();
		pos_1P_selector_btn_right.y = pos_1P_selector_btn_left.y;
		pos_2P_selector_btn_left.x = pos_img_2P_gravestone.x - img_2P_selector_btn_down_left.getwidth();
	...
	void on_draw(const Camera& camera)
	{
		...
		case PlayerType::Peashooter:
			...
			pos_img_1P_name.x = pos_img_1P_gravestone.x + (img_gravestone_right.getwidth() - textwidth(str_pershooter_name)) / 2;
			outtextxy(pos_img_1P_name.x, pos_img_1P_name.y, str_pershooter_name);
			break;
		case PlayerType::Sunflower:
		...
		case PlayerType::Peashooter:
			...
			pos_img_2P_name.x = pos_img_2P_gravestone.x + (img_gravestone_left.getwidth() - textwidth(str_pershooter_name)) / 2;
			outtextxy(pos_img_2P_name.x, pos_img_2P_name.y, str_pershooter_name);
			break;
		case PlayerType::Sunflower:
...
private:
	...
	LPCTSTR str_pershooter_name = _T("婉逗射手");       // 婉逗射手角色名
