...
IMAGE img_1P_winner;                           // 1P 获胜本文图片
IMAGE img_2P_winner;                           // 2P 获胜本文图片
IMAGE img_draw_player;                         // 平局本文图片
...
void load_game_resourcse()
{
	...
	loadimage(&img_draw_player, _T("resources/draw_player.png"));
